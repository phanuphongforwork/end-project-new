<template>
  <div>
    ...
    <div id="printMe" style="display: none; padding: 8px">
      <center>
        <h1>
          รายงานการเข้าร่วมตรวจสุขภาพ {{ new Date().getFullYear() + 543 }}
        </h1>
      </center>
      ...
      >
        <div style="width: 100%; display: flex">
          ...
          <div style="width: 100%; border-bottom-style: dotted">
            {{ dayjs(dataExport?.health_check_date).format("DD/MMMM/YYYY") }}
          </div>
        </div>
        <div style="width: 100%; display: flex">
